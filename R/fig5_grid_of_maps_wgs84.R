...
# CRS is NAD 1983
pca8 <- rast("D:/big-files-backup/ch03-sh-groups/clust8_pca.tif")
...
dummy <- terra::rast()
terra::crs(dummy) <- paste0('EPSG:', "4326") #epsg_dest
...
tiff(file = "figs/dpi300/pca_mapgrid_k8_latlon_textsize.tiff",
    width = 8,
    height = 8,
    units = "in",
    res = 300)
